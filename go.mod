...
require (
	...
	github.com/zerok-ai/zk-rawdata-reader v0.5.3-0.20231110111149-54f34d94c37e
	github.com/zerok-ai/zk-utils-go v0.5.15
)
...
require (
	...
	px.dev/pixie v0.0.0-20231017231333-e670eb63cb18 // indirect
)
